<?php
    ...
    $nameR = $classR = $descriptionR = $avatarR = "";
    ...
    if (isset($_POST['btn-add'])) {
        ...
        if($nameR !="" && $descriptionR !="" && $uploadR !=""){
            header("Location: ../../view/subject/subject_add_confirm_view.php?name=$nameR&class=$classR&description=$descriptionR&avatar=$uploadR");
        }
    }
?>